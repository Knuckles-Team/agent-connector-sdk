#!/usr/bin/env python3
# Copied from agent-packages/agent-utilities/scripts/check_gitignore_convergence.py for agent-connector-sdk (RF-ADR-009 lane SDK-CORE). Adapted: unchanged (fleet-shared REQUIRED set).
