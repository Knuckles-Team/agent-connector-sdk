#!/usr/bin/env python3
# Copied from agent-packages/agent-utilities/scripts/check_swallowed_errors.py for agent-connector-sdk (RF-ADR-009 lane SDK-CORE). Adapted: scans agent_connector_sdk/.
