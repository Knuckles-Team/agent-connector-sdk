#!/usr/bin/env python3
# Copied from agent-packages/agent-utilities/scripts/check_root_hygiene.py for agent-connector-sdk (RF-ADR-009 lane SDK-CORE). Adapted: unchanged; reads this repository's .repo-layout.toml.
