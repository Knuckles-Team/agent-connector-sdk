#!/usr/bin/env python3
# Copied from agent-packages/agent-utilities/scripts/check_no_env_sprawl.py for agent-connector-sdk (RF-ADR-009 lane SDK-CORE). Adapted: scans agent_connector_sdk/; agent_connector_sdk/config.py is the only file allowed to read os.environ.
