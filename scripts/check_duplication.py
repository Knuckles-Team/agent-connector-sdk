#!/usr/bin/env python3
# Copied from agent-packages/agent-utilities/scripts/check_duplication.py for agent-connector-sdk (RF-ADR-009 lane SDK-CORE). Adapted: process overrides read from os.environ (scripts do not import the runtime package).
