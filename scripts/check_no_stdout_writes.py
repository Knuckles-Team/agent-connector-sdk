#!/usr/bin/env python3
# Copied from agent-packages/agent-utilities/scripts/check_no_stdout_writes.py for agent-connector-sdk (RF-ADR-009 lane SDK-CORE). Adapted: the whole agent_connector_sdk/ package is served MCP surface; empty allowlist.
...
SERVED_PACKAGE = ROOT / "agent_connector_sdk"
