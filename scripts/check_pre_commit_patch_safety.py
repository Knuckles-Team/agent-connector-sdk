#!/usr/bin/env python3
# Copied from agent-packages/agent-utilities/scripts/check_pre_commit_patch_safety.py for agent-connector-sdk (RF-ADR-009 lane SDK-CORE). Adapted: unchanged.
